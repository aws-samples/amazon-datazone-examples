...
SMUS_PRODUCER_PROJECT_ID = EnvUtils.get_env_var("SMUS_PRODUCER_PROJECT_ID", required=True)
SMUS_CONSUMER_PROJECT_ID = EnvUtils.get_env_var("SMUS_CONSUMER_PROJECT_ID", required=True)
